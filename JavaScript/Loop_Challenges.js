...
//divisible by 3 from 100 down to 0 (**note, 0 is technically evenly divisible by any number except itself)
for(var i=100; i >= 0; i--) {
    if(i%3 == 0) {
        console.log(i);
    }
...
var thisSequence = [4, 2.5, 1, -0.5, -2, -3.5];
for(var i=0; i < thisSequence.length; i++){
    console.log(thisSequence[i]);
}
// Sigma
